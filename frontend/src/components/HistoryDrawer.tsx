...
export default function HistoryDrawer({ open, onClose, onSelect }: Props) {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 h-full w-96 bg-white border-l border-gray-200
          ...
          {jobs.map((job) => (
            <button
              ...
              className="w-full text-left p-3 rounded-lg bg-gray-50 hover:bg-gray-100
                         border border-gray-200 hover:border-gray-300 transition-colors cursor-pointer"
            >
